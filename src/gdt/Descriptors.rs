...
impl GDTDescriptor {
    pub fn new(base: u32, limit: u32, flags: u16) -> GDTDescriptor {
        return create_descriptor(base, limit, flags);
    }
}

fn create_descriptor(base: u32, limit: u32, flags: u16) -> GDTDescriptor {
